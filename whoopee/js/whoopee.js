...
//////////////
	...
	function make_generator(){
		...
		generator="<a href='/' class='bt'><i class='fa fa-home'></i></a><button class='bt' id='go'>Сгенерировать</button><!--button id='rnd' class='bt'>Перегенерировать</button--><a class='bt' href='/message/?theme=dndwhoopee' target='_blank'>Написать отзыв или предложение</a><a class='bt' href='https://tentaculus.ru/_files/Whoopee.docx' target='_blank'>Скачать источник-DOCX</a>";
		$("#whoopee").html(generator);
	...
	$("body").on("click", "#go", function(){		
		$("#result").html("<div class='result'>Результат гулянки: <br><br>" + joy_result() + "</div>");		
		$(".info_toggle").text("Показать описание");
		$(".description").slideUp();		
	});
	make_generator();
	add_info_spoiler();
